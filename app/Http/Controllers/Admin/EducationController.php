...
class EducationController extends Controller
{
    ...
    public function index(){
        ...
        return view('admin.education.index', compact('title'));
    }
    ...
    public function search(Request $request)
    {
        ...
        $response = $this->educationService->search($request);
    ...
    function store(Request $request){
        ...
        $response = $this->educationService->store($request);
        if($response){
    ...
    function destroy(Request $request){
        ...
        $response = $this->educationService->destroy($request);
        if($response){
