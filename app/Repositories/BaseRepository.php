...
abstract class BaseRepository implements RepositoryInterface
{
    ...
    protected function setClauses()
    {
        foreach ($this->wheres as $where) {
            if($where['operator'] == 'raw')
                $this->query->whereRaw($where['column'], $where['value']);
            else
     ...
     * @return bool
     */
    public function bulkInsert($values): bool
    {
        $table = $this->model::query()
                             ->getModel()
                             ->getTable();
    ...
    public function createOrUpdateData($args, $params)
    {
