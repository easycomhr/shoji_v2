                            ...
                            <div class="card mb-5 mb-xl-10">
                                <div class="card-body pt-9 pb-0">
                                    ...
                                    <div class="d-flex flex-wrap flex-sm-nowrap">
                                        @include('admin.user.partials.profile_header')
                                    </div>
                                    <!--end::Details-->

                                    <!--begin::Navs-->
                                    @include('admin.user.partials.profile_menu')
                                    <!--begin::Navs-->
                                </div>
                            </div>

                            @if($page == 'general')
                                @include('admin.user.partials.profile_general')
                            @elseif($page == 'personal')
                                @include('admin.user.partials.profile_personal')
                            @endif
