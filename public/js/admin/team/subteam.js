Ext.onReady(function(){
    ...
    var storeParent = Ext.create('Ext.data.Store', {
        fields : [
            'id', 'name'
        ],
        proxy : {
    ...
    function renderParent(value) {
        try {
            ...
            console.log('Store data:', storeParent.getData().items);

            if (value == null || value === '') {
                return '';
            }

            const record = storeParent.queryBy(function(rec) {
            ...
            console.error('Error in renderParentTeam:', e);
        }
    }
    ...
    mainGird = Ext.create('Ext.grid.Panel', {
        ...
        columns : [
            ...
            {
                text : HRMS_LABELS.lblParentTeam,
                dataIndex : 'parent_id',
                width : 210,
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'combobox',
                            fieldLabel: HRMS_LABELS.lblParentTeam,
                            name: 'parent_id',
                            store: storeParent, // Dùng storeLeaveCategory
