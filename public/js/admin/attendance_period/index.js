Ext.onReady(function(){
    ...
    mainGird = Ext.create('Ext.grid.Panel', {
        ...
        columns : [
            ...
            {
                header : HRMS_LABELS.lblFromDate,
                dataIndex : 'from_date',
                width: 180,
            ...
            {
                header : HRMS_LABELS.lblStandardWorkingDay,
                dataIndex : 'standard_working_days',
                width: 180,
                field : {
                    type : 'numberfield'
                },
            },
            {
                ...
                renderer: function(value, metaData, record) {
                    ...
                    return '<input type="checkbox" ' + checked + ' onchange="toggleLocked(this, ' + recordId + ')" />';
                }
            },
            {
                align: "center",
            ...
            items: [
                {
                    ...
                    items: [
                        ...
                        },
                        {
                            ...
                            fieldLabel: HRMS_LABELS.lblFromDate,
                            name: 'from_date',
                            format: 'd/m/Y',
                        },
                        {
                            xtype: 'datefield',  // Checkbox field
                            fieldLabel: HRMS_LABELS.lblToDate,
                            name: 'to_date',
                            format: 'd/m/Y',
                        },
                        {
                            xtype: 'numberfield',  // Checkbox field
                            fieldLabel: HRMS_LABELS.lblStandardWorkingDay,
    ...
    window.toggleLocked = function(checkbox, recordId) {
        try {
