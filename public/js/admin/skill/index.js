Ext.onReady(function(){
    ...
    Ext.define('Skill', {
        ...
        fields : [
            'id', 'code', 'name', 'allowance', 'note', 'status'
        ],
        ...
        columns : [
            {
                ...
                header : HRMS_LABELS.lblAllowance,
                dataIndex : 'allowance',
                width: 150,
                align: 'right',
                renderer: APP.formatNumber,
                field : {
                    type : 'numberfield'
                },
    ...
    function initModalEdit() {
        return Ext.create('Ext.window.Window', {
            title: HRMS_LABELS.lblCreateSkill,
            modal: true,
            width: 500,
            y: 100,
            items: [
                {
                    ...
                    items: [
                        ...
                        {
                            xtype: 'numberfield',
                            fieldLabel: HRMS_LABELS.lblAllowance,
                            name: 'allowance',
                            renderer: APP.formatNumber,
                        },
                        {
