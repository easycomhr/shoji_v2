Ext.onReady(function(){
    ...
    Ext.define('Office', {
        ...
        fields : [
            'id', 'code', 'name', 'address_line_1', 'address_line_2', 'fax_number'
        ],
        ...
        columns : [
            {
                ...
                header : HRMS_LABELS.lblPrimaryAddress,
                ...
                header : HRMS_LABELS.lblSecondAddress,
                ...
                header : HRMS_LABELS.lblFaxNumber,
                dataIndex : 'fax',
                width: 200,
                field : {
                    type : 'textfield'
    ...
    function createModalEdit() {
        return Ext.create('Ext.window.Window', {
            title: HRMS_LABELS.lblCreateOffice,
            modal: true,
            width: 500,
            y: 100,
            items: [
                ...
                items: [
                    {
                        ...
                        handler: function () {
                         ...
                         //   form.reset(); // Optionally reset the form after saving
                        }
                    },
                    {
    ...
    var modalEdit = createModalEdit();
    function onAddClick() {
        if (!modalEdit) {
            modalEdit = createModalEdit();
        }
        modalEdit.show();
    }
